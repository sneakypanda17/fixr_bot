...
input_file = os.path.join(os.path.dirname(__file__), "raw_data/first_names.csv")
output_file = os.path.join(os.path.dirname(__file__), "raw_data/first_names2.csv")
...
if not os.path.exists(input_file):
    ...
    with open(input_file, mode='r', newline='') as infile, open(output_file, mode='w', newline='') as outfile:
        ...
        writer = csv.DictWriter(outfile, fieldnames=[field for field in reader.fieldnames if field != 'newPerct2013'])
